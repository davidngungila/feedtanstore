...
@section('page-title', 'Review ' . $purchaseOrder->po_number)
...
<div class="animate-[fadeIn_0.4s_ease]">
    <div class="card rounded-2xl p-6 mb-6 border-l-4 border-yellow-500 bg-yellow-50">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('purchasing.orders.show', $purchaseOrder) }}" class="text-primary-600 hover:text-primary-800 font-medium">
                <i class="fas fa-arrow-left mr-2"></i>Back to Order
            </a>
        </div>
    </div>

    <form id="reviewForm" class="card rounded-2xl p-6">
