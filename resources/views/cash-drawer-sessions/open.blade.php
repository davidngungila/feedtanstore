    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="card rounded-2xl p-8 max-w-md w-full">
            ...
            <form action="{{ route('cash-drawer-sessions.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Opening Balance (TZS)</label>
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">TZS</span>
                            <input type="number" name="opening_balance" class="w-full pl-16 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-lg" required min="0" step="0.01" placeholder="0.00">
                        </div>
                    </div>
                    <div>
