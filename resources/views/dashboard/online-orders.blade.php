...
<div class="animate-[fadeIn_0.4s_ease] space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="card rounded-2xl p-5 overflow-hidden">
            ...
            <div class="text-lg sm:text-xl md:text-2xl font-bold break-all" :class="darkMode?'text-white':'text-primary-900'">TZS {{ number_format($filteredOnlineRevenue, 2) }}</div>
        ...
        <div class="card rounded-2xl p-5 overflow-hidden">
            ...
            <div class="text-lg sm:text-xl md:text-2xl font-bold break-all" :class="darkMode?'text-white':'text-primary-900'">{{ $filteredOnlineItems }}</div>
        </div>
    </div>
