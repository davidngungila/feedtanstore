    ...
    <div class="card rounded-2xl p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">SKU</p>
                </div>
            ...
            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Barcode</p>
                </div>
                <p class="font-bold text-gray-900">{{ $product->barcode ?? '-' }}</p>
            </div>

            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    <i class="fas fa-layer-group text-gray-600"></i>
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Category</p>
                </div>
                <p class="font-bold text-gray-900">{{ $product->category->name ?? '-' }}</p>
            </div>

            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    <i class="fas fa-tag text-gray-600"></i>
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Brand</p>
                </div>
                <p class="font-bold text-gray-900">{{ $product->brand->name ?? '-' }}</p>
            </div>

            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    <i class="fas fa-weight text-gray-600"></i>
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Unit</p>
                </div>
                <p class="font-bold text-gray-900">{{ $product->unit->name ?? '-' }}</p>
            </div>
            ...
            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Stock Level</p>
                </div>
            ...
            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Cost Price</p>
                </div>
                <p class="font-bold text-gray-900">TZS {{ number_format($product->cost_price, 2) }}</p>
            </div>

            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    <i class="fas fa-dollar-sign text-gray-600"></i>
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Selling Price</p>
                </div>
                <p class="font-bold text-gray-900">TZS {{ number_format($product->selling_price, 2) }}</p>
            </div>
            ...
            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <p class="text-xs font-semibold text-gray-700 uppercase tracking-wider">Reorder Level</p>
                </div>
                <p class="font-bold text-gray-900">{{ $product->reorder_level }}</p>
            </div>
        </div>
        ...
        <div class="mt-6 p-5 bg-gray-50 rounded-xl border border-gray-200">
            <div class="flex items-center gap-2 mb-3">
                ...
                <p class="text-sm font-semibold text-gray-700 uppercase tracking-wider">Expiry Date</p>
            </div>
            <p class="font-bold text-gray-900">
            ...
            <div class="mt-6 p-6 bg-gray-50 rounded-xl border border-gray-200">
                <div class="flex items-center justify-between flex-wrap gap-4 mb-5">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="text-lg font-bold text-gray-900">Product Barcode</h3>
                    </div>
                    <button onclick="printBarcode()" class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-xl transition-colors">
                ...
                <div class="flex flex-col lg:flex-row items-start gap-6">
                    <div class="bg-white p-6 rounded-xl border border-gray-200">
                        ...
                        <p class="text-center mt-3 font-mono text-sm text-gray-700 font-bold">{{ $product->barcode ?? $product->sku }}</p>
                    </div>
                    <div class="flex-1">
                        ...
                        <ul class="text-sm text-gray-600 space-y-1">
                            <li class="flex items-center gap-2">
                                <i class="fas fa-check-circle text-gray-600"></i>Compatible with most scanners
                            </li>
                            <li class="flex items-center gap-2">
                                <i class="fas fa-check-circle text-gray-600"></i>High resolution for clear printing
                            </li>
                        </ul>
                    </div>
                </div>
