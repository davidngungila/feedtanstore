    ...
    <div class="card rounded-2xl p-6 mb-6">
        ...
        @if($purchaseOrderRequest->status === 'pending')
            ...
            <div class="border-t border-gray-200 pt-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-1">Admin Actions</h3>
        ...
        <div class="border-t border-gray-200 pt-6">
            ...
            <div class="border border-gray-200 rounded-xl p-4 mb-4">
                ...
                <form action="{{ route('storekeeper.purchase-order-requests.receive', $item) }}" method="POST" id="receiveForm-{{ $item->id }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    @csrf
                    @method('PUT')
                    <div>
