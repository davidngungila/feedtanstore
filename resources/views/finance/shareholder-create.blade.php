...
@section('page-title', 'Add Shareholder')

@section('content')
<div class="animate-[fadeIn_0.4s_ease]">
    <div class="card rounded-2xl p-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-bold text-primary-900">Add Shareholder</h2>
            <a href="{{ route('finance.shareholders') }}" class="text-primary-600 hover:text-primary-800 font-medium">
                <i class="fas fa-arrow-left mr-2"></i>Back
            </a>
        </div>

        <form action="{{ route('finance.shareholders.store') }}" method="POST">
            @csrf
            ...
            <div class="mt-8 flex justify-end gap-3">
                <a href="{{ route('finance.shareholders') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                    Cancel
                </a>
