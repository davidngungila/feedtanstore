        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 card rounded-2xl overflow-hidden">
                <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                    <h2 class="font-semibold text-gray-900">Eligible Orders</h2>
                    <span class="text-sm text-gray-500">{{ $orders->count() }} ready</span>
                </div>
                ...
                <div class="max-h-[480px] overflow-y-auto divide-y divide-gray-100">
                    ...
                    @php
                        ...
                        $checked = in_array($order->id, $preselected, true) ? 'checked' : '';
                    @endphp
