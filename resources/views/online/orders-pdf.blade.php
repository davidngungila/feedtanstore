...
<body>
    ...
    <div class="container">
        ...
        <table style="width: 100%; margin-bottom: 15px;">
            <tr>
                <td>
                    ...
                    <div class="value">{{ ucwords(str_replace('_', ' ', $order->status)) }}</div>
                </td>
                <td style="text-align: right;">
                    <div class="label">Date:</div>
                    <div class="value">{{ $order->created_at->format('l, d F Y') }}</div>
                    <div class="value" style="font-size: 10px; color: #6b7280; font-weight: normal;">Time: {{ $order->created_at->format('H:i:s') }}</div>
                </td>
            </tr>
        </table>
        ...
        <div class="info-card">
            <table class="details-table">
                <tr>
                    ...
                    <td class="value" style="font-size: 14px;">{{ strtoupper($order->customer_name) }}</td>
                </tr>
                <tr>
                ...
                @if($order->rider)
                <tr>
                    <td class="label">Rider:</td>
                    <td class="value">{{ $order->rider->name }} ({{ $order->rider->phone }})</td>
                </tr>
                @endif
                <tr>
                    <td class="label">Payment Method:</td>
                    <td class="value">{{ $order->payment_method ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td class="label">Payment Status:</td>
                    <td class="value">{{ ucwords($order->payment_status) }}</td>
                </tr>
            </table>
        </div>

        <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Order Items:</h4>
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">TZS {{ number_format($item->price, 2) }}</td>
        ...
        <div class="info-card">
            <table class="details-table" style="width: 100%;">
                <tr>
                    ...
                    <td class="value" style="text-align: right;">TZS {{ number_format($order->subtotal, 2) }}</td>
                </tr>
                <tr>
        ...
        <div class="info-card" style="border-left: 4px solid #f59e0b;">
            ...
            <div class="value">{{ strtoupper($order->notes) }}</div>
        </div>
        @endif
