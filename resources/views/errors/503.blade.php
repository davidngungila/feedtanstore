...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-4 text-center">
        ...
        <p class="text-gray-600 mb-4">We're currently undergoing maintenance. Please check back soon.</p>
        <div class="mb-8">
            <p class="text-gray-600 mb-2">For urgent inquiries, please contact our system administrator:</p>
