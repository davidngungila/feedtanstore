...
<div class="animate-[fadeIn_0.4s_ease]">
    <div class="card rounded-2xl p-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-bold text-primary-900">Customer Credit</h2>
        </div>
            ...
            <table class="data-table w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-red-600 font-semibold">TZS {{ number_format($customer->balance, 2) }}</td>
                        <td class="text-gray-600">TZS {{ number_format($customer->credit_limit, 2) }}</td>
