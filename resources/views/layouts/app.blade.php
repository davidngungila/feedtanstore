  ...
  <template x-if="isStorekeeper">
    <aside :class="[sidebarOpen?'translate-x-0':'lg:translate-x-0 -translate-x-full','sidebar sidebar-bg fixed lg:relative h-screen z-50 flex flex-col transition-all duration-300',sidebarCollapsed&&window.innerWidth>=1024?'w-16':'w-[260px]']"
      ...
      <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
        ...
        <!-- Receive New Stock -->
        <a href="{{ route('storekeeper.stock-receiving') }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-150 group {{ request()->routeIs('storekeeper.stock-receiving*') ? 'bg-primary-600 text-white' : 'text-primary-200 hover:bg-white/10 hover:text-white' }}">
          <i class="fa-solid fa-truck-loading w-4 text-center flex-shrink-0"></i>
  ...
  <template x-if="isMarketingOfficer">
    <aside :class="[sidebarOpen?'translate-x-0':'lg:translate-x-0 -translate-x-full','sidebar sidebar-bg fixed lg:relative h-screen z-50 flex flex-col transition-all duration-300',sidebarCollapsed&&window.innerWidth>=1024?'w-16':'w-[260px]']"
      ...
      <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
        ...
        <!-- Products -->
        <a href="{{ route('inventory.products') }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-150 group {{ request()->routeIs('inventory.products') || request()->routeIs('inventory.products.create') || request()->is('inventory/products/*/edit') ? 'bg-primary-600 text-white' : 'text-primary-200 hover:bg-white/10 hover:text-white' }}">
        ...
        <!-- Price Management -->
        <a href="{{ route('price-requests.prices') }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-150 group {{ request()->routeIs('price-requests*') ? 'bg-primary-600 text-white' : 'text-primary-200 hover:bg-white/10 hover:text-white' }}">
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
      ...
      <div>
        ...
        <div :class="activeSection === 'inventory'?'max-h-[2000px]':'max-h-0'" class="overflow-hidden transition-all duration-300 ml-3" x-show="!sidebarCollapsed">
          ...
          <a href="{{ route('price-requests.prices') }}" class="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition-all duration-150 mt-0.5 {{ request()->routeIs('price-requests.prices*') ? 'bg-primary-600/80 text-white' : 'text-primary-300 hover:bg-white/10 hover:text-white' }}">
            <i class="fa-solid fa-circle text-[6px] flex-shrink-0 ml-1"></i>
            Price Management
          </a>
        </div>
      ...
      <div>
        ...
        <div :class="activeSection === 'purchasing'?'max-h-[2000px]':'max-h-0'" class="overflow-hidden transition-all duration-300 ml-3" x-show="!sidebarCollapsed">
          ...
          <a href="{{ route('purchasing.purchase-requests') }}" class="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition-all duration-150 mt-0.5 {{ request()->routeIs('purchasing.purchase-requests*') ? 'bg-primary-600/80 text-white' : 'text-primary-300 hover:bg-white/10 hover:text-white' }}">
            <i class="fa-solid fa-circle text-[6px] flex-shrink-0 ml-1"></i>
            Purchase Requests
          </a>
      ...
      <div x-data="{ open: {{ request()->routeIs('reports.*') ? 'true' : 'false' }} }">
        ...
        <div :class="open?'max-h-[1000px]':'max-h-0'" class="overflow-hidden transition-all duration-300 ml-3" x-show="!sidebarCollapsed">
          ...
          <a href="{{ route('cash-drawer-sessions.daily') }}" class="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs transition-all duration-150 mt-0.5 {{ request()->routeIs('cash-drawer-sessions.daily') ? 'bg-primary-600/80 text-white' : 'text-primary-300 hover:bg-white/10 hover:text-white' }}">
            <i class="fa-solid fa-calendar-day text-[10px] flex-shrink-0 text-amber-400"></i>
