...
<body>
     ...
     <div class="container">
         <div class="header">
             ...
             <div class="receipt-title">EXPIRING SOON REPORT</div>
         </div>

         <div class="info-card">
             <div style="font-size: 12px; color: #4b5563;">
                 <strong>Report Date:</strong> {{ now()->format('l, d F Y H:i:s') }}<br>
                 <strong>Expiring Within:</strong> {{ $days }} days
             </div>
         </div>

         <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Expiring Products:</h4>
         <table class="items-table">
             ...
             <tbody>
                 ...
                 @if($products->isEmpty())
                 <tr>
                     <td colspan="6" style="text-align: center;">No products expiring soon</td>
                 </tr>
                 @endif
             </tbody>
         </table>
