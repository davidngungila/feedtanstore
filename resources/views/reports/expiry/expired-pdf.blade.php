...
<body>
     ...
     <div class="container">
         <div class="header">
             ...
             <div class="receipt-title">EXPIRED PRODUCTS REPORT</div>
         </div>

         <div class="info-card">
             <div style="font-size: 12px; color: #4b5563;">
                 <strong>Report Date:</strong> {{ now()->format('l, d F Y H:i:s') }}<br>
                 <strong>Total Expired Value:</strong> TZS {{ number_format($totalValue, 2) }}
             </div>
         </div>

         <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Expired Products:</h4>
         <table class="items-table">
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>{{ $product->expiry_date->format('d F Y') }}</td>
                     <td style="text-align: right;">TZS {{ number_format($product->quantity * $product->cost_price, 2) }}</td>
                 </tr>
                 @endforeach
                 @if($products->isEmpty())
                 <tr>
                     <td colspan="6" style="text-align: center;">No expired products</td>
                 </tr>
                 @endif
             </tbody>
         </table>
