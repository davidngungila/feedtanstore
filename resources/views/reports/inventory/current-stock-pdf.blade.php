...
<body>
     ...
     <div class="container">
         <div class="header">
             ...
             <div class="receipt-title">CURRENT STOCK</div>
         </div>
         ...
         <div class="stats-grid">
             ...
             <div class="stat-card">
                 ...
                 <div class="stat-value">{{ $products->filter(fn($p) => $p->quantity <= $p->reorder_level)->count() }}</div>
             </div>
         </div>

         <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Product List:</h4>
