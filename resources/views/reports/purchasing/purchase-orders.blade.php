    ...
    <div class="card rounded-2xl p-6 mb-6">
        <div class="flex flex-wrap items-center justify-between mb-6 gap-4">
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-2">
                    ...
                    <input type="date" name="start_date" id="start_date" value="{{ request('start_date', today()->subDays(30)->toDateString()) }}" class="form-input input-field px-4 py-2">
                </div>
                <div class="flex items-center gap-2">
                ...
                <a href="{{ route('reports.purchasing.purchase-orders.download', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'status' => request('status')]) }}" class="px-4 py-2 border border-primary-200 rounded-lg text-primary-700 hover:bg-primary-50 font-medium transition-colors">
                    Export PDF
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5">
                ...
                <p class="text-sm text-blue-700 mb-1">Total Amount</p>
                <h3 class="text-2xl font-bold text-blue-900">TZS {{ number_format($purchaseOrders->sum('total'), 2) }}</h3>
            </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right text-gray-700 font-medium">Subtotal</th>
                        <th class="px-4 py-3 text-right text-gray-700 font-medium">Tax</th>
                ...
                <tbody class="divide-y">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right font-semibold">TZS {{ number_format($order->subtotal, 2) }}</td>
