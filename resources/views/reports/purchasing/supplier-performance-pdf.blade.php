...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="receipt-title">SUPPLIER PERFORMANCE REPORT</div>
        </div>
        ...
        <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Suppliers:</h4>
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">{{ $supplier->purchaseOrders->count() }}</td>
                    <td style="text-align: right;">TZS {{ number_format($supplier->purchaseOrders->sum('total'), 2) }}</td>
                </tr>
                @endforeach
                @if($suppliers->isEmpty())
                <tr>
                    <td colspan="5" style="text-align: center;">No data found for this period</td>
                </tr>
                @endif
            </tbody>
        </table>
