...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="receipt-title">PURCHASE ORDERS REPORT</div>
        </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">TZS {{ number_format($order->subtotal, 2) }}</td>
                    <td style="text-align: right;">TZS {{ number_format($order->tax, 2) }}</td>
