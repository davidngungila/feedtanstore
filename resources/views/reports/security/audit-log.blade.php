...
<div class="animate-[fadeIn_0.4s_ease]">
    <div class="card rounded-2xl p-6 mb-6">
        <div class="flex flex-wrap items-center justify-between mb-6 gap-4">
            <h2 class='text-xl font-bold text-primary-900'>System Audit Log</h2>
            <form method="GET" action="{{ route('reports.security.audit-log') }}" class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ route('reports.security.audit-log.download', ['start_date' => request('start_date', $startDate), 'end_date' => request('end_date', $endDate)]) }}" class="px-4 py-2 border border-primary-200 rounded-lg text-primary-700 hover:bg-primary-50 font-medium transition-colors">Export PDF</a>
            </form>
        </div>
        ...
        <div class="text-center py-10 text-gray-500">
            ...
            <p>No activity logged in this period.</p>
        </div>
        @else
