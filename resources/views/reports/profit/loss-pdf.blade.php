...
<head>
    <meta charset="utf-8">
    <title>Loss Report - {{ $startDate }} to {{ $endDate }}</title>
    <style>
         body {
...
<body>
     ...
     <div class="container">
         <div class="header">
             ...
             <div class="receipt-title">LOSS REPORT</div>
         </div>
         ...
         <div class="stats-grid">
             <div class="stat-card">
                 ...
                 <div class="stat-value">TZS {{ number_format($totalLoss, 2) }}</div>
             </div>
             <div class="stat-card">
                 <div class="stat-label">Adjustments</div>
                 <div class="stat-value">{{ $adjustments->count() }}</div>
             </div>
             <div class="stat-card">
                 <div class="stat-label">Products</div>
                 <div class="stat-value">{{ $adjustments->pluck('product_id')->unique()->count() }}</div>
             </div>
             <div class="stat-card">
         ...
         <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Adjustments Breakdown:</h4>
         <table class="items-table">
             ...
             <tbody>
                 ...
                 <tr>
                     <td colspan="6" style="text-align: center;">No data found for this date range</td>
                 </tr>
                 @endif
             </tbody>
         </table>
