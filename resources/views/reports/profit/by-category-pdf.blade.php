...
<head>
    <meta charset="utf-8">
    <title>Profit By Category Report - {{ $startDate }} to {{ $endDate }}</title>
    <style>
         body {
...
<body>
     ...
     <div class="container">
         <div class="header">
             ...
             <div class="receipt-title">PROFIT BY CATEGORY REPORT</div>
         </div>
         ...
         <div class="stats-grid">
             <div class="stat-card">
                 ...
                 <div class="stat-value">TZS {{ number_format($categories->sum('total_sales'), 2) }}</div>
             </div>
             <div class="stat-card">
                 <div class="stat-label">Total Cost</div>
                 <div class="stat-value">TZS {{ number_format($categories->sum('total_cost'), 2) }}</div>
             </div>
             <div class="stat-card">
                 <div class="stat-label">Total Profit</div>
                 <div class="stat-value">TZS {{ number_format($categories->sum('profit'), 2) }}</div>
             </div>
             <div class="stat-card">
         ...
         <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Category Breakdown:</h4>
         <table class="items-table">
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td style="text-align: right;">TZS {{ number_format($category->total_cost, 2) }}</td>
                     <td style="text-align: right;">TZS {{ number_format($category->profit, 2) }}</td>
                     <td style="text-align: right;">{{ number_format($category->margin_percent, 2) }}%</td>
                 </tr>
                 @endforeach
