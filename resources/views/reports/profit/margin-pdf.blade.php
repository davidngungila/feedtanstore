...
<head>
    <meta charset="utf-8">
    <title>Profit Margin Report - {{ $startDate }} to {{ $endDate }}</title>
    <style>
         body {
...
<body>
     ...
     <div class="container">
         <div class="header">
             ...
             <div class="receipt-title">PROFIT MARGIN REPORT</div>
         </div>
         ...
         <div class="stats-grid">
             <div class="stat-card">
                 ...
                 <div class="stat-value">TZS {{ number_format($products->sum('total_sales'), 2) }}</div>
             </div>
             <div class="stat-card">
                 <div class="stat-label">Total Profit</div>
                 <div class="stat-value">TZS {{ number_format($products->sum('profit'), 2) }}</div>
             </div>
             <div class="stat-card">
                 <div class="stat-label">Avg Margin</div>
                 <div class="stat-value">{{ $products->isNotEmpty() ? number_format($products->avg('margin_percent'), 2) : 0 }}%</div>
             </div>
             <div class="stat-card">
         ...
         <h4 style="font-size: 12px; color: #111; font-weight: bold; margin-bottom: 10px;">Product Breakdown:</h4>
         <table class="items-table">
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td style="text-align: right;">TZS {{ number_format($product->total_cost, 2) }}</td>
                     <td style="text-align: right;">TZS {{ number_format($product->profit, 2) }}</td>
                     <td style="text-align: right;">{{ number_format($product->margin_percent, 2) }}%</td>
                 </tr>
                 @endforeach
                 @if($products->isEmpty())
                 <tr>
                     <td colspan="7" style="text-align: center;">No data found for this date range</td>
                 </tr>
                 @endif
             </tbody>
         </table>
