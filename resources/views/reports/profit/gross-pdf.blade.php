...
<head>
    <meta charset="utf-8">
    <title>Gross Profit Report - {{ $startDate }} to {{ $endDate }}</title>
    <style>
         body {
...
<body>
     ...
     <div class="container">
         <div class="header">
             ...
             <div class="receipt-title">GROSS PROFIT REPORT</div>
         </div>
         ...
         <div class="stats-grid">
             ...
             <div class="stat-card">
                 ...
                 <div class="stat-value">TZS {{ number_format($totalCost, 2) }}</div>
             </div>
             <div class="stat-card">
                 <div class="stat-label">Gross Profit</div>
                 <div class="stat-value">TZS {{ number_format($totalProfit, 2) }}</div>
             </div>
             <div class="stat-card">
         ...
         <table class="items-table">
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td style="text-align: right;">TZS {{ number_format($product->total_sales - $product->total_cost, 2) }}</td>
                 </tr>
                 @endforeach
                 @if($products->isEmpty())
                 <tr>
