...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('storekeeper')->name('storekeeper.')->group(function () {
        ...
        Route::post('/products/{id}/link-barcode', [\App\Http\Controllers\StorekeeperController::class, 'linkBarcode'])->name('products.link-barcode');
    ...
    Route::prefix('inventory')->name('inventory.')->group(function () {
        ...
        Route::delete('/products/{identifier}', [\App\Http\Controllers\ProductController::class, 'destroy'])->name('products.destroy');
    ...
    Route::prefix('finance')->name('finance.')->group(function () {
        ...
        Route::get('/transactions/{entry}/download', [\App\Http\Controllers\FinanceController::class, 'exportTransactionPDF'])->name('transactions.download');
